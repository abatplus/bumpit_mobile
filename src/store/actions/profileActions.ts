...
import { clearList } from './swapActions';
...
export enum ActionTypes {
    ...
    UNSET_CURRENT_PROFILE_ID = 'UNSET_CURRENT_PROFILE_ID',
}
...
export const setCurrentProfileId = (profileId: string) => {
    return {
        type: ActionTypes.SET_CURRENT_PROFILE_ID,
        payload: profileId,
    };
};

export const unsetCurrentProfileId = () => {
    return {
        type: ActionTypes.SET_CURRENT_PROFILE_ID,
    };
};
...
export const setProfileVCardDataField = (
    profileId: string,
    profileName: string,
