...
export class CardExchangeServerTest {
  ...
  testMultipleInstances = () => {
    ...
    optimus.Hub.Subscribe('1111', 0, 0, 'Optimus Prime', '')
      .then((_) => this.sleep(1))
      .then((_) => megatron.Hub.Subscribe('2222', 0, 0, 'Megatron', ''))
      .then((_) => this.sleep(1))
      .then((_) => optimus.Hub.Update('1111', 0.1, 0.1, 'Optimus'))
      .then((_) => this.sleep(1))
      .then((_) => megatron.Hub.Unsubcribe('2222'))
      .then((_) => this.sleep(1))
      .then((_) => optimus.Hub.Update('1111', 0.2, 0.2, 'Optimus'))
      .then((_) => this.sleep(1))
      .then((_) => megatron.Hub.Subscribe('3333', 0, 0, 'Galvatron', ''))
      .then((_) => this.sleep(1))
      .then((_) => optimus.Hub.Update('1111', 0.3, 0.3, 'Optimus'))
      .then((_) => this.sleep(1))
      .then((_) => console.log('END LIFECYCLE / START EXCHANGE'))
      .then((_) => this.sleep(1))
      .then((_) => optimus.Hub.RequestCardExchange('1111', '3333', 'Optimus Prime(1)'))
      .then((_) => this.sleep(1))
      .then((_) => optimus.Hub.RevokeCardExchangeRequest('1111', '3333'))
      .then((_) => this.sleep(1))
      .then((_) => optimus.Hub.RequestCardExchange('1111', '3333', 'Optimus Prime(2)'))
      .then((_) => this.sleep(1))
      .then((_) => megatron.Hub.AcceptCardExchange('1111', '3333', 'Galvatronus', 'Decepticons', ''))
      .then((_) => this.sleep(1))
