...
export interface ICardExchangeHub {
  Subscribe: (deviceId: string, longitude: number, latitude: number, displayName: string, image: string) => Promise<void>;
  ...
  AcceptCardExchange: (deviceId: string, peerDeviceId: string, peerDisplayName: string, peerCardData: string, peerImage: string) => Promise<void>;
