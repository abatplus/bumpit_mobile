...
export default class ContactApi {
     ...
     * @memberof ContactApi
     */
    public createContact(vCardFields: IVCard, base64Image: string | undefined | null) {
        ...
        if (vCardFields.company) {
            contact.organizations = [
                new ContactOrganization('work', vCardFields.company, undefined, vCardFields.position),
            ];
        }
        ...
        if (base64Image) contact.photos = [new ContactField('base64', base64Image, true)];
