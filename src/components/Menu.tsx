...
import { IonContent, IonItem, IonLabel, IonList, IonMenu, IonMenuToggle, IonFooter, IonImg } from '@ionic/react';
...
const Menu: React.FC = () => {
  ...
  const menuItemColor = window.matchMedia('(prefers-color-scheme: dark)').matches ? 'secondary' : '';
